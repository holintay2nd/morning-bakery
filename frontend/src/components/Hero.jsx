...
// SNS 아이콘 정의 (Simple Icons 공식 SVG) — sectionId: 페이지 내 해당 섹션 앵커
const SNS_ICONS = [
  {
    key: 'instagram',
    label: 'Instagram 섹션으로 이동',
    sectionId: 'sns-instagram',
    viewBox: '0 0 24 24',
  ...
  {
    key: 'youtube',
    label: 'YouTube 섹션으로 이동',
    sectionId: 'sns-youtube',
    viewBox: '0 0 24 24',
    path: 'M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z',
  },
  {
    key: 'naverBlog',
    label: '네이버 블로그 섹션으로 이동',
    sectionId: 'sns-naverblog',
    viewBox: '0 0 24 24',
  ...
  {
    key: 'threads',
    label: 'Threads 섹션으로 이동',
    sectionId: 'sns-threads',
    viewBox: '0 0 24 24',
  ...
  return (
    ...
    >
      ...
      <div ref={textRef} className="relative z-10 text-center text-white px-5 max-w-3xl">
        ...
        {/* SNS 아이콘 뱃지 — 클릭 시 페이지 내 해당 SNS 섹션으로 스크롤 */}
        <div className="flex items-center justify-center gap-5">
          {SNS_ICONS.map(({ key, label, sectionId, viewBox, path, iconClass }) => (
            <button
              key={key}
              onClick={() => document.querySelector(`#${sectionId}`)?.scrollIntoView({ behavior: 'smooth' })}
              aria-label={label}
